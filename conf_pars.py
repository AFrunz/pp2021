"""Парсер конференций, возвращает имя, дату начала и конца, дату окончания подачи заявок,
страну и город проведения, ссылку"""
