"""Парсинг билетов самолетов (Не вижу модификатор ссылки и не вижу где дата возврата указывается
Входные данные: Город отправления, город прибытия, день, месяц
Выходные данные: Компания, ссылка, цена, кол-во пересадок, аэропорт отправления, аэропорт прибытия, время отправления, время прибытия
тип???? и багаж.
"""
